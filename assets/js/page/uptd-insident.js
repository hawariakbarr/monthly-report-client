...
userForm.addEventListener("submit", function(e){  
  ...
  $.ajax({
    url: `${urlData}insident/add-uptd-insident`,
    type: 'POST',
    ...
    success: function (result) {
        ...
        if(result.error)
        {
          ...
          iziToast.success({
            title: 'Keluhan UPTD Berhasil Ditambahkan',
...
async function getDatatableUptd(urlData){
    await $.ajax({
      url: `${urlData}insident/get-all-uptd-insident`,
      type: 'GET',
      headers: {
...
function editData(id){
    $('#editFormData').on("submit", function(e){
        ...
        var editlistUptd = document.getElementById('listeditUptd').value
        ...
        $.ajax({
        url: `${urlData}insident/update-uptd-insident/` + id,
        type: 'PUT',
        headers: {
            "Authorization": getCookie("session")
        },
...
async function deleteUptd(id){
    var result = confirm("Are you sure to delete this data?");
    if (result) 
        $.ajax({
        url: `${urlData}insident/delete-uptd-insident/` + id,
        type: 'DELETE',
        headers: {
            "Content-Type": "application/x-www-form-urlencoded",
            "Authorization": getCookie("session")
